...
class UserController extends Controller
{
    public function escrever(){
        ...
        if($texto['texto'][count($texto['texto']) - 1]['descricao'] == ""){
            $texto['texto'][count($texto['texto']) - 1] = ['titulo' => $texto['texto'][count($texto['texto']) - 1]['titulo'] ,
                                                            ...
                                                            "aspectos" => ["subtitulo" => $_POST['subtitulo'], 
                                                            "subdescricao" => $_POST['subdescricao']]];
        }else{
            $texto['texto'][count($texto['texto']) - 1] = ['titulo' => $texto['texto'][count($texto['texto']) - 1]['titulo'] ,
                                                            'descricao' => $texto['texto'][count($texto['texto']) - 1]['descricao'],
                                                            "aspectos"[count($texto['texto'][count($texto['texto']) - 1]['aspectos']) - 1] => ["subtitulo" => $_POST['subtitulo'], 
                                                            "subdescricao" => $_POST['subdescricao']]];
        }
    ...
    public function criar(){
        ...
        $texto['texto'][count($texto['texto']) - 1] = ['titulo' => $_POST['titulo'], 'descricao' => "", "aspectos" => ["subtitulo" => "", "subdescricao" => ""]];
